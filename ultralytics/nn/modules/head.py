...
__all__ = "Detect", "Segment", "Pose", "Classify", "OBB", "RTDETRDecoder", "DetectAux", "OBB_Aux"
...
class OBB_Aux(DetectAux):
    ...
    def __init__(self, nc=80, ne=1, ch=()):
        ...
        super().__init__(nc, ch)
        self.ne = ne  # number of extra parameters
        self.detect = DetectAux.forward

        c4 = max(ch[0] // 4, self.ne)
        self.cv4 = nn.ModuleList(
            nn.Sequential(Conv(x, c4, 1), Conv(c4, c4, 3), nn.Conv2d(c4, self.ne, 1)) for x in ch)
